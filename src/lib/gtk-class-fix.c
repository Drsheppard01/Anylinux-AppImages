...
static GApplication *(*real_gtk_application_new)(const char *,
                                                 GApplicationFlags);
static void (*real_g_application_set_application_id)(GApplication *,
                                                     const char *);
...
static void (*real_gdk_wayland_window_set_app_id)(void *window,
                                                  const char *app_id);
...
static void init(void) {
  ...
  real_g_application_set_application_id =
  ...
  real_gdk_wayland_window_set_app_id =
      dlsym(RTLD_NEXT, "gdk_wayland_window_set_app_id");
...
GApplication *g_application_new(const char *application_id,
                                GApplicationFlags flags) {
  init();
  return real_g_application_new
             ? real_g_application_new(effective_id(application_id), flags)
             : NULL;
}

GApplication *gtk_application_new(const char *application_id,
                                  GApplicationFlags flags) {
  init();
  return real_gtk_application_new
             ? real_gtk_application_new(effective_id(application_id), flags)
             : NULL;
}

void g_application_set_application_id(GApplication *app,
...
__attribute__((constructor)) static void gtk_class_fix_ctor(void) {
  init();
