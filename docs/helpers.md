# Scripts which help you build Anylinux-AppImage
...
# The following functions and env variables are always available for shs to use
...
## Fixing unprivileged user namespaces
